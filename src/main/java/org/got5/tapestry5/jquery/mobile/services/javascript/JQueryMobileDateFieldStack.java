...
/**
 * Replacement for the Jquery datefield core stack {@link DateFieldStack}.
 *
 *  @author GOT5
 */
public class JQueryMobileDateFieldStack implements JavaScriptStack
{
	public static final String STACK_ID = "JqueryMobileDateField";
    ...
    public JQueryMobileDateFieldStack(final ThreadLocale threadLocale,
